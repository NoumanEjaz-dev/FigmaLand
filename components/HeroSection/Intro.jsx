    ...
    <>
      <section className={styles.Intro}>
        <div className="screen-bg">
          <div className={`${styles.Heading} items-center pt-40  text-center`}>
            <h1
              className={`${styles.HeroHeading} xl:w-1/3 md:w-1/2 sm:w-1/2 m-auto  lg:text-7xl text-white font-light text-center mb-8`}
            >
