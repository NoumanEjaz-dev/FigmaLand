  ...
  return (
    <>
      <div className="Features-Section pb-10">
        ...
        <p
          className={`${styles.FeaturesPara} text-center pt-2 text-xl text-black-400 leading-10 xl:w-1/5 lg:w-1/4 md:w-1/3 sm:w-1/2 m-auto`}
        >
          Most calendars are designed for teams. Slate is designed for
          freelancers
        </p>
        <p
          className={`${styles.FeaturesParaSm} sm:hidden text-center pt-2 text-xl text-black-400 leading-10 xl:w-1/4 lg:w-1/4 md:w-1/3 sm:w-1/2 m-auto`}
        >
          Most calendars are designed for teams.
        </p>
        {/*  */}
        <section
          className={`${styles.container} block sm:hidden text-gray-600 body-font pt-10`}
        >
          <div className="mx-auto flex flex-col w-11/12 justify-center items-center">
            <video
              className={`${styles.video} block sm:hidden`}
              controls
              width="1100"
              height="660"
            >
            ...
            <div class="flex flex-wrap md:w-7/12 lg:w-7/12 w-9/12 m-auto">
              <div class="lg:w-1/3 lg:mb-0 mb-6 p-6">
                <div class="h-full text-center">
                  ...
                  <h1
                    className={`${styles.FeatureService}  text-2xl text-black pb-3`}
                  >
                    OpenType features Variable fonts{" "}
                  </h1>

                  <p
                    className={`${styles.FeatureServicePara} leading-7 text-black`}
                  >
              ...
              <div class="lg:w-1/3 lg:mb-0 mb-6 p-6">
                <div class="h-full text-center">
                  ...
                  <h1
                    className={`${styles.FeatureDesign} text-2xl text-black pb-3`}
                  >
        ...
        <section className="text-gray-600 body-font">
          <div className="container mx-auto flex flex-col w-9/12 justify-center items-center">
            <video
